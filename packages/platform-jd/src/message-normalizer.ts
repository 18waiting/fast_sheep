// M8 JD message normalization (clean-room). Canonical contract via common.
...
export function normalizeJDMessage(input: Omit<NormalizeInput, "platform">): NormalizedInboundMessage {
  return normalizeMessage({ ...input, platform: "jd" });
}
