# @fastwork/platform-qianniu

Clean-room M8 (TASK-023) Qianniu (抖店) web-platform adapter. Implements the M5
PlatformAdapter boundary with a versioned synthetic DOM contract
(qianniu-dom-1.0.0, PARTIAL/DESIGN provenance). No real seller network/login in
