// M8 Qianniu message normalization (clean-room). Canonical contract via common.
...
export function normalizeQianniuMessage(input: Omit<NormalizeInput, "platform">): NormalizedInboundMessage {
  return normalizeMessage({ ...input, platform: "qianniu" });
}
