// M8 Kuaishou capability matrix (clean-room). Source: spec/platforms/
// platform-adapter-matrix.md + transfer-matrix.md.
import type { PlatformCapabilities } from "@fastwork/platform-web-common";

export const KUAISHOU_CAPABILITIES: PlatformCapabilities = {
  receive_text: true,
  send_text: true,
  send_image: true,
...
export const KUAISHOU_CAPABILITY_CERTAINTY: Record<string, string> = {
